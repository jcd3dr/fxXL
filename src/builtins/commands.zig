...
pub const top_level_specs = [_]TopLevelSpec{
    ...
    .{
        .kind = .login,
        .token = "login",
        .usage = "login [vercel|codex|grok|compat]",
        .summary = "Sign in to Vercel or a selected provider",
    },
    .{
        .kind = .logout,
        .token = "logout",
        .usage = "logout [vercel|codex|grok|compat]",
    ...
    .{
        .kind = .provider,
        .token = "provider",
        .usage = "provider <gateway|codex|grok|compat>",
...
pub const top_level_help_groups = [_]TopLevelHelpGroup{
    ...
    .{ .entries = &.{
        .{ .kind = .login, .usage = "login [vercel|codex|grok|compat]" },
        .{ .kind = .logout, .usage = "logout [vercel|codex|grok|compat]" },
        .{ .kind = .provider, .usage = "provider <gateway|codex|grok|compat>" },
...
pub const slash_specs = [_]SlashSpec{
    ...
    .{ .kind = .logout, .command = "/logout", .help_entry = "/logout [vercel|codex|grok|compat]", .completion_description = "sign out of a provider session", .presentation_category = .account, .has_args = true, .accepts_payload = true },
