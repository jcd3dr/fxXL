...
const openai_compat_permission_reviewer = @import("../gateway/openai_compat_permission_reviewer.zig");
...
pub const native = provider_set.Set{
    ...
    .compat = .{
        .presentation = provider_catalog.find(.compat),
        .auth_strategy = .compat,
        .agent_stream = openai_compat.agent_stream_provider,
        .cli_model_catalog = openai_compat_models.cli_model_catalog_provider,
        .model_catalog = openai_compat_models.model_catalog_provider,
        .permission_reviewer = openai_compat_permission_reviewer.provider,
    },
};
